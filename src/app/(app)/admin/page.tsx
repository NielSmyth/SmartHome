              ...
              <TableRow key={device.id}>
                ...
                <TableCell className="text-right">
                    <CrudDialog
                        ...
                        formFields={formFields}
                        isOpen={isDialogOpen && editingDevice?.id === device.id}
                        setIsOpen={setIsDialogOpen}
                    >
                      <Button
                        variant="ghost"
...
const SceneManagement = () => {
    ...
    const onSubmit = (data: any) => {
        if (editingScene) {
            handleUpdateScene(editingScene.id, data);
        } else {
                    ...
                    <TableBody>
                        {scenes.map((scene) => (
                            <TableRow key={scene.id}>
                                ...
                                <TableCell className="text-right">
                                    <CrudDialog schema={sceneFormSchema} defaultValues={scene} onSubmit={onSubmit} dialogTitle="Edit Scene" dialogDescription="Update this scene." formFields={formFields} isOpen={isDialogOpen && editingScene?.id === scene.id} setIsOpen={setIsDialogOpen}>
                                    ...
                                    <AlertDialog>
                                        ...
                                        <AlertDialogContent>
                                            ...
                                            <AlertDialogFooter>
                                                <AlertDialogCancel>Cancel</AlertDialogCancel>
                                                <AlertDialogAction onClick={() => handleDeleteScene(scene.id)}>Continue</AlertDialogAction>
                                            </AlertDialogFooter>
                                        </AlertDialogContent>
                                    </AlertDialog>
                                </TableCell>
                    ...
                    <TableBody>
                        {automations.map((automation) => (
                            <TableRow key={automation.id}>
                                ...
                                <TableCell className="text-right">
                                    <CrudDialog schema={automationFormSchema} defaultValues={automation} onSubmit={onSubmit} dialogTitle="Edit Automation" dialogDescription="Update this automation rule." formFields={formFields} isOpen={isDialogOpen && editingAutomation?.id === automation.id} setIsOpen={setIsDialogOpen}>
                                    ...
                                    <AlertDialog>
                                        ...
                                        <AlertDialogContent>
                                            ...
                                            <AlertDialogFooter>
                                                <AlertDialogCancel>Cancel</AlertDialogCancel>
                                                <AlertDialogAction onClick={() => handleDeleteAutomation(automation.id)}>Continue</AlertDialogAction>
                                            </AlertDialogFooter>
                                        </AlertDialogContent>
                                    </AlertDialog>
                                </TableCell>
